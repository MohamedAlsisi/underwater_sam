...
data_root = '/home/osim-mir/student/mo/sam/data/USIS10K'
...
default_hooks = dict(
    # keep any existing hooks here (timer, logger, checkpoint, etc.)
    visualization=dict(
        type='DetVisualizationHook',
        draw=True,      # actually draw predictions
        show=False      # don’t open GUI, just save
    )
)
